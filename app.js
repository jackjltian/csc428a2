...
var participant = prompt("Please enter the participant number (on consent form):", "");
var techinque = prompt("Please enter the technique (1, 2, 3):", "");
var canvas_landscape = prompt("Please enter canvas landscape (column, row, square):", "");
var target_radius = prompt("Please enter preferred target radius (small, medium, large):", "");
var totalBlock = 10;
var currentBlock = 1;
var totalTrials = 10;
var currentTrial = 0;
...
//new canvas
if (canvas_landscape == "square"){
w = 500;
h = 500;
}  else if (canvas_landscape == "column") {
w = 700;
h = 500;
} else if (canvas_landscape == "row") {
w = 400;
h = 500;
}

//new target radius
if (target_radius == "small"){
  minRadius = 5;
  maxRadius = 10;
} else if (target_radius == "medium") {
  minRadius = 10;
  maxRadius = 15;
} else if (target_radius == "large") {
  minRadius = 15;
  maxRadius = 20;
}
    ...
    if (capturedTargetIdx == clickTarget) {
      ...
      if (currentTrial == totalTrials) {
        ...
        if (currentBlock == totalBlock) {
          ...
          saveAs(
            blob,
            "P" + participant + "_" + currentTechnique + "_" + canvas_landscape + "_" + target_radius + "_data.txt"
          );
